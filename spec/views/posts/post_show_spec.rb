...
RSpec.describe 'test users index page', type: :feature do
    ...
    let!(:second_user) do
        user = User.create(name: 'Franko', photo: 'https://picsum.photos/200', bio: 'Instructor and GADS.')
    end
    ...
    let!(:first_comment) do
        first_comment = Comment.create(post: first_post, author: second_user, text: 'Is this true Micheal?')
    end
    before(:each) do
