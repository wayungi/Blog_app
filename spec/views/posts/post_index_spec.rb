...
RSpec.describe 'test post index page', type: :feature do
  # create users
  let!(:first_user) do
    User.create(name: 'Vitorio', photo: 'https://picsum.photos/200', bio: 'Instructor and GADS.')
  end
  let!(:second_user) do
    User.create(name: 'Anne', photo: 'https://picsum.photos/200', bio: 'Instructor and GADS.')
  end
  ...
  let!(:first_comment) do
    Comment.create(post: first_post, author: second_user, text: 'Is this true Vitorio?')
  end
